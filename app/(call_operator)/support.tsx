...
export default function SupportScreen() {
  ...
  const handleCreateTicket = async () => {
    if (!newTicketData.customerName || !newTicketData.title || !newTicketData.description) {
    ...
    try {
      await addSupportTicket({
        ...newTicketData,
        customerId: Date.now().toString(), // Generate customer ID
      });
    ...
    <View style={styles.ticketCard}>
      ...
      <View style={styles.ticketInfo}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoText}>{ticket.customerPhone}</Text>
        </View>
        <View style={styles.infoRow}>
      ...
      <View style={styles.actionButtons}>
        {ticket.status === 'open' && !ticket.technicianId && (
          <TouchableOpacity
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.formContainer}>
              <TextInput
                ...
                onChangeText={(text) => setNewTicketData({...newTicketData, customerName: text})}
              />
              ...
              <TextInput
                ...
                onChangeText={(text) => setNewTicketData({...newTicketData, customerPhone: text})}
